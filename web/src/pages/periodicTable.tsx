...
/* 
	...
	Este arquivo é o frontend da tabela periódica
*/
export default function PeriodicTable() {

	const families = [
		"alkaline-metals","alkaline-earth-metals","lanthanoids","actinoids","transition-metals","post-transition-metals","metaloids",
		"other-nonmetals","noble-gasses",
	]
	return (
		...
		<div className="wrapper">
			{families.map( (family) => {
				return(
					<div>
						<input className="category-toggle" type="radio" id={family} name="categories" />
						<input className="category-cancel" id="cancel" type="radio" name="categories" />
					</div>
				)
			})}
